...
Public Class Language
    ...
    Friend b_clear As String = "Logout"
    ...
    Friend l_loading As String = "Loading your badges page. Please wait..." & vbCrLf & "If program have no response for a long time, restart and try again."


    Public Sub init()
        Dim lang = System.Threading.Thread.CurrentThread.CurrentCulture.ToString()
        If lang.IndexOf("zh-CN") >= 0 Then
            title = "Steam 挂卡工具"
            msg_appstart = " 开始"
            msg_appstop = " 停止"
            ...
            l_loading = "正在读取徽章页面，请稍候..." & vbCrLf & "如果程序长时间没有响应，请关闭程序再试一次。"
        ElseIf lang.IndexOf("zh") >= 0 Then
            title = "Steam 掛卡工具"
            msg_appstart = " 開始"
            msg_appstop = " 停止"
            ...
            l_loading = "正在讀取徽章頁面，請稍候..." & vbCrLf & "如果程式長時間沒有回應，請關閉程式再試一次。"
        End If
    End Sub
End Class
